...
async function sendContact(e) {
  e.preventDefault();
  const f = e.target;
  await api('/api/contact', { method: 'POST', body: JSON.stringify({ name: f.name.value, email: f.email.value, subject: f.subject.value, message: f.message.value, whatsapp: f.whatsapp.value }) });
